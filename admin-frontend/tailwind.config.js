...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['"LXGW WenKai"', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'Helvetica Neue', 'Arial', 'sans-serif'],
        // 定义标准的宋体序列 (STSong, SimSun 等)
        song: ['"LXGW WenKai"', '"Noto Serif SC"', '"Source Han Serif SC"', 'STSong', '"SimSun"', 'serif'],
        // 定义标准的楷体序列 (Kaiti SC, STKaiti 等)
        kai: ['"LXGW WenKai"', '"Kaiti SC"', '"STKaiti"', '"KaiTi"', '"楷体"', 'serif'],
        xingkai: ['"LXGW WenKai"', '"STXingkai"', '"Xingkai SC"', '"HuaWenXingKai"', '"FZXingKai-Z04S"', 'serif'],
        serif: ['"LXGW WenKai"', '"Noto Serif SC"', '"Source Han Serif SC"', 'STSong', '"SimSun"', 'serif'],
      },
      keyframes: {
        'ink-bloom': {
